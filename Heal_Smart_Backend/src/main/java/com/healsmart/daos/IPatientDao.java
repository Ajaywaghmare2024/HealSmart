...
public interface IPatientDao extends JpaRepository<Patient,Integer> {
	...
	int updatePatientPrescription(@Param("prescription") String prescription,
			@Param("patId") int patId);
