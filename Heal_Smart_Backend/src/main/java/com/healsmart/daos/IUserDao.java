...
public interface IUserDao extends JpaRepository<User, Integer> {
	...
	int updateFirstNameLastNameDobCellNo(
			@Param("firstName")String firstName,
			@Param("lastName") String lastName,
			@Param("dob") Date dob,@Param("cellNo") String cellNo,
	...
	int insertIntoUsers(@Param("id") int userId,
			@Param("firstName") String firstName,
			@Param("lastName") String lastName,
			@Param("email") String email,
			@Param("password") String password,
			@Param("cellNo") String cellNo,
	...
	@Query(value = "update users set first_name= :firstName,"
			+ "last_name= :lastName,cell_no= :cellNo where id= :userId",nativeQuery = true)
